...
EditURL: https://blog.hatena.ne.jp/morihaya/morihaya.hatenablog.com/atom/entry/4207112889981500001
---

OpenAIのChatGPTや、MicrosoftのBingやAzure OpenAI Serviceで世間が賑わっている中、やっとというかやはりというかAWSも以下の二つを出してきました。

[https://aws.amazon.com/blogs/aws/amazon-codewhisperer-free-for-individual-use-is-now-generally-available/:embed:cite]

[https://aws.amazon.com/blogs/machine-learning/announcing-new-tools-for-building-with-generative-ai-on-aws/:embed:cite]
...
<figure class="figure-image figure-image-fotolife" title="Approved CodeWhisperer post">[f:id:morihaya:20230415165332p:plain]<figcaption>Approved CodeWhisperer post</figcaption></figure>とりあえず良い記事だったので、UpVote をしておきました。

## 導入していく

紹介記事も読み終えたので実際に導入を進めていきます。先程の記事の "sign up" から以下のページへ飛びます。

[https://aws.amazon.com/codewhisperer/resources/:embed:cite]
...
[https://marketplace.visualstudio.com/items?itemName=AmazonWebServices.aws-toolkit-vscode:embed:cite]
...
<figure class="figure-image figure-image-fotolife" title="CodeWhisperer on Status bar">[f:id:morihaya:20230415171532p:plain]<figcaption>CodeWhisperer on Status bar</figcaption></figure>

どうしようかとドキュメントを見直すと、ページ下にVSCとIntelliJそれぞれの動画が用意されており、それをみたら簡単にわかりました。

<figure class="figure-image figure-image-fotolife" title="Enable CodeWhisperer in VSC">[f:id:morihaya:20230415171922p:plain]<figcaption>Enable CodeWhisperer in VSC</figcaption></figure>
...
<figure class="figure-image figure-image-fotolife" title="Select an authentication method to use AWS CodeWhisperer">[f:id:morihaya:20230415172040p:plain]<figcaption>Select an authentication method to use AWS CodeWhisperer</figcaption></figure>


あくまで個人の検証ですので"1. 個人用途のAWS Builders ID"で進めることにします。すると以下の画面にいきなり案内されましたが、手持ちに入力すべきOTPはありません。

<figure class="figure-image figure-image-fotolife" title="Authentication for AWS Codebuilders ID">[f:id:morihaya:20230415173416p:plain]<figcaption>Authentication for AWS Codebuilders ID</figcaption></figure>

仕方ないのでこれを機にBuilders IDを作成することとします。

[https://docs.aws.amazon.com/signin/latest/userguide/create-aws_builder_id.html:embed:cite]

特に難しいことはなく、MFA用のデバイス登録までシュッと完了し、改めてVSCからCodeWhispererの利用をリトライします。

いい感じです。

<figure class="figure-image figure-image-fotolife" title="Succeeded CodeWhisperer">[f:id:morihaya:20230415173823p:plain]<figcaption>Succeeded CodeWhisperer</figcaption></figure>
