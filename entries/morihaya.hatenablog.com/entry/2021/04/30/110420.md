...
EditURL: https://blog.hatena.ne.jp/morihaya/morihaya.hatenablog.com/atom/entry/26006613722496462
---
...
<figure class="figure-image figure-image-fotolife" title="Retrieving files with Github actions">[f:id:morihaya:20210430113011p:plain]<figcaption>Retrieving files with Github actions</figcaption></figure>
...
- `git diff --exit-code` で差分があった場合のリターンコードを変更((これをしないと基本的に 0 がリターンされる))
