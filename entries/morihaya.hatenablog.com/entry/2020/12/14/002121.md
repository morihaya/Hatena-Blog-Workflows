...
EditURL: https://blog.hatena.ne.jp/morihaya/morihaya.hatenablog.com/atom/entry/26006613664755606
---
...
<figure class="figure-image figure-image-fotolife" title="正常状態は結果がみれてわかりやすい">[f:id:morihaya:20201213234522p:plain]<figcaption>check監視のグラフ</figcaption></figure>


存在しないドメイン (googleeeeeeeeeee.co.jp)  を入れると以下のようにエラーになりました。

<figure class="figure-image figure-image-fotolife" title="dns check error">[f:id:morihaya:20201213235149p:plain]<figcaption>dns check error</figcaption></figure>
...
そして冒頭にも書いたように、直接コマンドを書いて見たところ無事に期待した動作となりましたとさ。ちゃんちゃん。((これがダメだった場合はGoで頑張るかーとなっていたところですが、シュッと設定できてよかったです。))
