...
hatena:
  ...
  edit_url: "https://blog.hatena.ne.jp/morihaya/morihaya.hatenablog.com/atom/entry/13574176438085407372"
---

2時間くらいで最低限使える感じになりました。
リポジトリはこちら。
[GitHub - morihaya/jsto: Display the time in each country from Japan Standard Time JST · GitHub](https://github.com/morihaya/jsto)
...
- JST在住の自分が世界の標準時を知るためのコマンドで "JST to hoge" すなわち`jsto` ってコマンド名イケてるのでは [^1]
...
![Go CLI Libraries](/images/fotolife/20220423001109.png)
...
[GitHub - spf13/cobra: A Commander for modern Go CLI interactions · GitHub](https://github.com/spf13/cobra)
...
[cobra-cli/README.md at main · spf13/cobra-cli · GitHub](https://github.com/spf13/cobra-cli/blob/main/README.md)
...
[time package - time - Go Packages](https://pkg.go.dev/time#Time.UTC)


探し回ると LoadLocation のサンプルがやりたいことに近いことがわかりました。

[time package - time - Go Packages](https://pkg.go.dev/time#example-LoadLocation)
