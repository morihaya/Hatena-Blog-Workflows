...
hatena:
  ...
  edit_url: "https://blog.hatena.ne.jp/morihaya/morihaya.hatenablog.com/atom/entry/13574176438103810222"
---

`aws s3 presign` を使うと時間経過で失効するURLを生成できます。そのURLからは誰でもS3上の該当ファイル[^1]にアクセスが可能です。
この機能を利用することでトラブルシュートなどで普段AWSを利用しないユーザに対してファイルを共有したいケースでも簡単に対応することができるよ、なメモです。

[presign — AWS CLI 2.36.13 Command Reference](https://docs.aws.amazon.com/cli/latest/reference/s3/presign.html)
...
[Add new s3 "presign" command · aws/aws-cli@d34b89a · GitHub](https://github.com/aws/aws-cli/commit/d34b89a0d32f36ed4948b19afe4dd00c6c95ab3c)
...
![SlackでPresignedなURLを送りつけるの図](/images/fotolife/20220619222748.png)
...
![presignedの有効期限が切れた場合のエラー](/images/fotolife/20220619223715.png)
