...
hatena:
  ...
  edit_url: "https://blog.hatena.ne.jp/morihaya/morihaya.hatenablog.com/atom/entry/26006613608414149"
---

EC2で稼働していたDockerのサブネットを後から変更したのでメモします。
大体はこちらのブログの通りです。感謝。

[On-premise virtual machine sunset](https://support.getjoan.com/hc/en-us/articles/360008889859-How-to-change-the-Docker-default-subnet-IP-address)
...
[GitHub - boschkundendienst/guacamole-docker-compose: Guacamole with docker-compose using PostgreSQL, nginx with SSL (self-signed) · GitHub](https://github.com/boschkundendienst/guacamole-docker-compose)
...
[Apache Guacamole®: Release Archives](https://guacamole.apache.org/releases/)
