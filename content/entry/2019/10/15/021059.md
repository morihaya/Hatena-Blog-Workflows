...
hatena:
  ...
  edit_url: "https://blog.hatena.ne.jp/morihaya/morihaya.hatenablog.com/atom/entry/26006613448571710"
---

digdagを利用していて時おり困ることの一つに、何らかのジョブ[^1]がハングなどで長時間実行されてしてしまい、ジョブのキューが溜まり後続のジョブが実行されない問題があります。その対策として sla ディレクティブを利用した、という内容です。
...
* 超過した場合、終了時に[notificateion.type](https://github.com/treasure-data/digdag/issues/669)による通知を実行する場合は `alert: true` [^4]
...
[^3]: このオプションの説明が[Release Note](https://docs.digdag.io/releases/release-0.8.1.html?highlight=sla)にしかなくて分かりづらいので、[ドキュメント修正のPR](https://github.com/treasure-data/digdag/pull/1236)を出したりしました
